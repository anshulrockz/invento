    ...
    <div class="page-content">
		<div class="page-bar">
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="{{url('/accounts/view/1')}}">Danish</a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                		...
                		<form method="post" action="">
	                        <div class="form-body">
							    ...
							    <div class="form-group">
							      ...
							      <input type="text" class="form-control" name="hsn" id="hsn" value="" placeholder="Please Enter HSN Code" >
							    </div>
							    <div class="form-group">
							      <label>*Parent Acount Name:</label>
							      <input type="text" class="form-control" name="pan" id="pan" value="" placeholder="Please Enter Parent Acount Name" required="">
							    </div>
							    <div class="form-group">
