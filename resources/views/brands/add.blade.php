    ...
    <div class="page-content">
		...
		<div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject font-blue-sharp bold uppercase">Add Brand</span>
                </div>
            </div>
                		...
                		<form method="post" action="">
	                        <div class="form-body">
							    ...
							    <div class="form-group">
							      ...
							      <textarea class="form-control" name="description" id="description" placeholder="Please Enter Description">{{ old('address') }}</textarea>
							    </div>
	                        </div>
